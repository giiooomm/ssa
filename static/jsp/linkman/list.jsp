											...
											<TBODY>
												...
												<s:iterator value="#PageBean.list" var="linkman" >
													<TR
														...
														<input type="hidden" value="linkman.lkmId">
														<TD><s:property value="#linkman.lkmCustId.custName" /></TD>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												条
												[<A href="javascript:void(0)" onclick="to_page($('#page').val() * 1 - 1)">前一页</A>]
												<B><s:property value='#PageBean.currentPage'/></B>
												[<A href="javascript:void(0)" onclick="to_page($('#page').val() * 1 + 1)">后一页</A>] 
												到
												<input type="text" size="3" id="page"  value="<s:property value='#PageBean.currentPage'/>"/>
												页
